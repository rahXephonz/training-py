...
# 3 - Load Game Assets ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# 3.1 - Load Images
player = pygame.image.load((r'C:/Users/Quetzalcoatl/Documents/resources/images/dude.png'))
grass = pygame.image.load((r'C:/Users/Quetzalcoatl/Documents/resources/images/grass.png'))
castle = pygame.image.load((r'C:/Users/Quetzalcoatl/Documents/resources/images/castle.png'))
arrow = pygame.image.load((r'C:/Users/Quetzalcoatl/Documents/resources/images/bullet.png'))
enemy_img = pygame.image.load((r'C:/Users/Quetzalcoatl/Documents/resources/images/badguy2.png'))
## 4 - The Game Loop ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
while(running):
